...
$cases = @(
    ...
    @{ Name = 't2-b3-rect-blind-override'; Expect = "the dump carries no line with 'verdict=covered'"; Path = 'tools/FerriteLib.UiKit.Tests/KernelDevGeometryTests.cs'; Old = '            UiNative.ButtonOverride = rect => Over(rect, point);'; New = '            UiNative.ButtonOverride = rect => true; // mutation: rect-blind'; Run = 'run-fl-harness-dev.cmd'; Rebuild = 'rebuild-fl-tests-dev.cmd'; Configuration = 'Dev' },
